...
class ProjectAgent:
    ...
    def load(self):
        self.model.load_state_dict(torch.load("best_policy_2.pt"))
        print("Model loaded")
        self.model.eval()
    ...
    def train(self, env, max_episode):
        ...
        while episode < max_episode:
            ...
            if done or trunc:
                ...
                validation_score = (
                    evaluate_HIV(agent=self, nb_episode=1) if episode >= 75 else -1
                )
                ...
                print(
                    ...
                    ", ep return ",
                    "{:4.2f} M".format(episode_cum_reward / 1e6),
                    ", validation score ",
                    "{:4.2f} M".format(validation_score / 1e6),
                    sep="",
                )
